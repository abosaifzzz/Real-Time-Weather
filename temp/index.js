...
//     type: "GET",
//     url:
//       "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/forecast/daily?APPID=9b4bbf30228eb8528d36e79d05da1fac&lat=" +
//       latitude +
//       "&lon=" +
//       longitude +
//       "&units=metric&cnt=5",
...
//   var arr = str.split(" ").map(function (sentence) {
...
let response = await fetch(`http://api.weatherapi.com/v1/search.json?key=61e846cbe7f14cb8bdb182821242206&q=lond`)
